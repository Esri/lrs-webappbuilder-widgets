...
define([
    ...
    return declare([BaseWidgetSetting, WidgetsInTemplateMixin], {
        ...
        setConfig: function(config) {
            ...
            this._overlayLineSymbolChooser.showBySymbol(this._getLineSymbol(config, "overlayLineSymbol"));
            this._overlayPointSymbolChooser.showBySymbol(this._getPointSymbol(config, "overlayPointSymbol"));
        },
        ...
        getConfig: function() {
            ...
            var overlayLineSymbol = this._overlayLineSymbolChooser.getSymbol();
            var overlayPointSymbol = this._overlayPointSymbolChooser.getSymbol();
            return {
                ...
                overlayLineSymbol: overlayLineSymbol.toJson(),
                overlayPointSymbol: overlayPointSymbol.toJson(),
